...
public class DeclinedReadingFactory {
	...
	private DeclineCopy copy(ReadingDeclineReason reason) {
		return switch (reason) {
			...
			case HIGH_STAKES_DECISION -> decisionCopy(
				"중대한 결정은 리딩이 대신 정하기 어려워요",
				"잘못된 선택이 생명, 신체, 법적 지위 또는 생활 기반에 크고 되돌리기 어려운 피해를 줄 수 있는 결정은 타로·사주로 정해 드리지 않아요.",
				"결정 자체가 아닌 지금 느끼는 부담이나 바라는 방향으로 질문을 바꾸면 리딩을 이어갈 수 있어요.",
				"이 안내와 리딩은 중요한 현실 판단이나 전문적인 조언을 대신하지 않습니다."
			);

...
- 정상 리딩은 `output.resultType`을 `reading`으로 쓰고 `readingMode`, `questionRedirected`, `title`, `summary`, `natalSections`, `annualReading`, `questionReading`, `guidance`, `disclaimer`를 `output.reading` 안에 넣으세요.
